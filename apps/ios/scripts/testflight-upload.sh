...
LIVE_ACTIVITY_BUNDLE_ID="${LIVE_ACTIVITY_BUNDLE_ID:-com.nightvibes.alleycat.liveactivity}"
LIVE_ACTIVITY_PROVISIONING_PROFILE_SPECIFIER="${LIVE_ACTIVITY_PROVISIONING_PROFILE_SPECIFIER:-}"
LIVEPROCESS_BUNDLE_ID="${LIVEPROCESS_BUNDLE_ID:-com.nightvibes.alleycat.liveprocess}"
LIVEPROCESS_PROVISIONING_PROFILE_SPECIFIER="${LIVEPROCESS_PROVISIONING_PROFILE_SPECIFIER:-}"
WATCH_BUNDLE_ID="${WATCH_BUNDLE_ID:-com.nightvibes.alleycat.watchkitapp}"
WATCH_PROVISIONING_PROFILE_SPECIFIER="${WATCH_PROVISIONING_PROFILE_SPECIFIER:-}"
WATCH_COMP_BUNDLE_ID="${WATCH_COMP_BUNDLE_ID:-com.nightvibes.alleycat.watchkitapp.complications}"
