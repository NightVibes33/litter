...
//! `generate-bindings.sh` emits them into the generated Swift.
//!
...
/// plain strings so the generated Swift enum is straightforward to
/// consume.
...
pub enum IshBootstrapError {
    ...
    #[error("ish: {0}")]
    Ish(String),
    /// Returned from UniFFI stubs on non-iOS targets (Mac Catalyst,
