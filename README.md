...
4. Run `.github/workflows/ios-unsigned-ipa.yml`. The unsigned IPA workflow downloads the private asset ZIP, verifies the SHA256, embeds it under `BuildKitAssets`, and the app can install it from Settings -> BuildKit or auto-install bundled assets on launch.
