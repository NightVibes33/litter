...
export CPP_aarch64_apple_ios="${CPP_aarch64_apple_ios:-$IOS_CLANG -E}"
export CXXCPP_aarch64_apple_ios="${CXXCPP_aarch64_apple_ios:-$IOS_CLANGXX -E}"
...
if [ "$SKIP_SIM" != "true" ]; then
  ...
  export CPP_aarch64_apple_ios_sim="${CPP_aarch64_apple_ios_sim:-$SIM_CLANG -E}"
  export CXXCPP_aarch64_apple_ios_sim="${CXXCPP_aarch64_apple_ios_sim:-$SIM_CLANGXX -E}"
  export CPP_x86_64_apple_ios="${CPP_x86_64_apple_ios:-$SIM_CLANG -E}"
  export CXXCPP_x86_64_apple_ios="${CXXCPP_x86_64_apple_ios:-$SIM_CLANGXX -E}"
