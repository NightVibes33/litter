...
require_grep "KittyStore source-owned news feed" ".flatMap(\\.news)" "apps/ios/Sources/Litter/Views/KittyStoreView.swift"
require_grep "KittyStore real source news empty state" "sourceNewsEmptyPanel" "apps/ios/Sources/Litter/Views/KittyStoreView.swift"
require_absent "KittyStore generated app release news" "latestReleaseNewsItem" "apps/ios/Sources/Litter/Views/KittyStoreView.swift"
...
require_grep "KittyStore coordinated document imports" "NSFileCoordinator(filePresenter: nil)" "apps/ios/Sources/Litter/Views/KittyStoreView.swift"
require_grep "KittyStore binary pairing plist normalization" "normalizePairingFileData" "apps/ios/Sources/Litter/Views/KittyStoreView.swift"
