...
require_path "Feather signed IPA install server" "apps/ios/Sources/Litter/Models/FeatherSignedIPAInstallServer.swift"
...
require_absent "Feather ZsignSwift package dependency is not linked in fast build" "product: ZsignSwift" "apps/ios/project.yml"
require_absent "Feather Zsign package is not linked into app target in fast build" "../../ThirdParty/Feather/Source/Zsign" "apps/ios/project.yml"
...
require_grep "emexDE CI patches LiveProcess source plist metadata" "ensure_liveprocess_info_plist_metadata" ".github/workflows/ios-unsigned-ipa.yml"
require_grep "emexDE CI patches LiveProcess plist bundle id" '<string>$(PRODUCT_BUNDLE_IDENTIFIER)</string>' ".github/workflows/ios-unsigned-ipa.yml"
require_grep "emexDE CI patches LiveProcess plist executable" '<string>$(EXECUTABLE_NAME)</string>' ".github/workflows/ios-unsigned-ipa.yml"
require_grep "emexDE CI patches LiveProcess plist package type" "<string>XPC!</string>" ".github/workflows/ios-unsigned-ipa.yml"
...
require_grep "emexDE private LiveProcess workflow bundle id is Litter-prefixed" 'PRODUCT_BUNDLE_IDENTIFIER="com.sigkitten.litter.liveprocess"' ".github/workflows/ios-unsigned-ipa.yml"
...
require_absent "Feather certificate signing no longer launches LocalDevVPN" "localdevvpn://enable" "apps/ios/Sources/Litter/Views/FeatherSigningSettingsView.swift"
...
require_absent "Feather certificate signing no longer reads KittyStore account state" "Sign in from KittyStore Settings" "apps/ios/Sources/Litter/Views/FeatherSigningSettingsView.swift"
...
require_grep "AltStore source screenshots verifier" "--require-screenshots" ".github/workflows/ios-unsigned-ipa.yml"
require_grep "AltStore source compact news verifier" "--max-news-items 3" ".github/workflows/ios-unsigned-ipa.yml"
require_grep "AltStore source compact news limit" "MAX_SOURCE_NEWS_ITEMS = 3" ".github/workflows/ios-unsigned-ipa.yml"
require_grep "AltStore source screenshot hero" "01-hero-iphone-1320x2868.png" ".github/workflows/ios-unsigned-ipa.yml"
require_grep "AltStore source screenshot remote" "02-remote-iphone-1320x2868.png" ".github/workflows/ios-unsigned-ipa.yml"
require_grep "AltStore source screenshot generative UI" "07-generative-ui-iphone-1320x2868.png" ".github/workflows/ios-unsigned-ipa.yml"
require_grep "AltStore source screenshot realtime voice" "05-realtime-voice-iphone-1320x2868.png" ".github/workflows/ios-unsigned-ipa.yml"
require_grep "KittyStore static source screenshots" "screenshotURLs" "ThirdParty/SideStore/Source/kittystore-source.json"
...
require_grep "BuildKit keeps KittyStore login embedded" "Apple ID sign-in, 2FA, pairing, and LocalDevVPN stay inside KittyStore" "apps/ios/Sources/Litter/Views/BuildKitSettingsView.swift"
