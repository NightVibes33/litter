...
require_grep "Litter bootstraps KittyStore defaults through Swift module" "KittyStoreEmbeddedFactory.bootstrap()" "apps/ios/Sources/Litter/LitterApp.swift"
require_grep "Litter uses direct KittyStore Swift module import" "import SideStore" "apps/ios/Sources/Litter/LitterApp.swift"
require_grep "Litter preserves upstream KittyStore app delegate inheritance" "class AppDelegate: SideStore.AppDelegate" "apps/ios/Sources/Litter/LitterApp.swift"
require_grep "KittyStore host direct Swift module import" "import SideStore" "apps/ios/Sources/Litter/Views/KittyStoreHostView.swift"
...
require_grep "Litter embeds and links KittyStore framework" "- target: SideStore" "apps/ios/project.yml"
