...
require_grep "unsigned IPA disables LiveProcess extension for sideload signer stability" 'LITTER_PRESERVE_NYXIAN_LIVEPROCESS: "0"' ".github/workflows/ios-unsigned-ipa.yml"
