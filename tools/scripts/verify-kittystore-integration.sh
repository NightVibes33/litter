...
require_grep "Minimuxer target owns native link flags" "-lminimuxer-ios" "apps/ios/project.yml"
...
require_absent "Litter launch does not bootstrap KittyStore" "KittyStoreEmbeddedFactory.bootstrap()" "apps/ios/Sources/Litter/LitterApp.swift"
require_absent "Litter launch SideStore import" "import SideStore" "apps/ios/Sources/Litter/LitterApp.swift"
require_absent "Litter launch SideStore delegate inheritance" "class AppDelegate: SideStore.AppDelegate" "apps/ios/Sources/Litter/LitterApp.swift"
require_absent "KittyStore host direct SideStore import" "import SideStore" "apps/ios/Sources/Litter/Views/KittyStoreHostView.swift"
...
require_grep "Litter embeds SideStore without launch link" "link: false" "apps/ios/project.yml"
require_grep "CI rejects launch-linked KittyStore framework" "KittyStore/minimuxer must stay dynamically loaded after launch" ".github/workflows/ios-unsigned-ipa.yml"
