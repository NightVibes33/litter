...
require_grep "KittyStore local source avoids duplicate app-linked news" '"news": []' "ThirdParty/SideStore/Source/kittystore-source.json"
require_absent "KittyStore workflow no longer requires duplicate news download cards" "--require-news-downloads" ".github/workflows/ios-unsigned-ipa.yml"
