...
require_grep "SideStore minimuxer tunnel config binding" "TunnelConfigBinding" "apps/ios/Sources/Litter/Models/KittyStoreMinimuxerBridge.swift"
require_grep "SideStore LocalDevVPN override IP" "10.7.0.1" "apps/ios/Sources/Litter/Models/KittyStoreMinimuxerBridge.swift"
require_grep "SideStore NetworkObserver bridge" "NetworkObserver.shared.start" "apps/ios/Sources/Litter/Models/KittyStoreMinimuxerBridge.swift"
