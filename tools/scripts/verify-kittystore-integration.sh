...
require_grep "Feather ZsignSwift package dependency" "product: ZsignSwift" "apps/ios/project.yml"
require_grep "Feather Zsign local package path" "../../ThirdParty/Feather/Source/Zsign" "apps/ios/project.yml"
...
require_grep "Feather certificate signing direct runner uses ZsignSwift" "Zsign.sign" "apps/ios/Sources/Litter/Models/FeatherSigningMaterialStore.swift"
