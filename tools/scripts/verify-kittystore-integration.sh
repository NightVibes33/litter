...
require_grep "Litter eagerly prepares KittyStore defaults like 1.5.52" "KittyStoreEmbeddedFactory.bootstrap()" "apps/ios/Sources/Litter/LitterApp.swift"
...
require_grep "Litter app imports launch-linked SideStore" "import SideStore" "apps/ios/Sources/Litter/LitterApp.swift"
...
require_grep "KittyStore host applies embedded theme refresh" "KittyStoreEmbeddedFactory.applyCurrentTheme(to:" "apps/ios/Sources/Litter/Views/KittyStoreHostView.swift"
...
require_grep "Litter minimuxer bridge uses embedded SideStore module" "import SideStore" "apps/ios/Sources/Litter/Models/KittyStoreMinimuxerBridge.swift"
