...
require_path "Litter crash reporter" "apps/ios/Sources/Litter/Models/LitterCrashReporter.swift"
...
require_grep "Litter crash reporter installs MetricKit" "MXMetricManager.shared" "apps/ios/Sources/Litter/Models/LitterCrashReporter.swift"
require_grep "Litter crash reporter captures Objective-C exceptions" "NSSetUncaughtExceptionHandler" "apps/ios/Sources/Litter/Models/LitterCrashReporter.swift"
require_grep "Litter crash reporter captures fatal signals" "litterFatalSignalHandler" "apps/ios/Sources/Litter/Models/LitterCrashReporter.swift"
require_grep "Litter crash reports visible in Files" "UIFileSharingEnabled" "apps/ios/Sources/Litter/Info.plist"
require_grep "Litter crash reporter installed before app model init" "LitterApp.init.begin" "apps/ios/Sources/Litter/LitterApp.swift"
require_grep "Litter crash reporter marks AppModel prewarm" "AppModel.prewarmResult.begin" "apps/ios/Sources/Litter/Models/AppModel.swift"
...
require_absent "Litter does not eagerly bootstrap KittyStore before home screen" "KittyStoreEmbeddedFactory.bootstrap()" "apps/ios/Sources/Litter/LitterApp.swift"
require_grep "Litter documents lazy KittyStore startup" "KittyStore is prepared lazily from KittyStoreHostView" "apps/ios/Sources/Litter/LitterApp.swift"
...
require_absent "Litter app does not import launch-linked SideStore" "import SideStore" "apps/ios/Sources/Litter/LitterApp.swift"
require_absent "Litter app delegate does not subclass launch-linked SideStore" "SideStore.AppDelegate" "apps/ios/Sources/Litter/LitterApp.swift"
require_absent "KittyStore host does not import launch-linked SideStore" "import SideStore" "apps/ios/Sources/Litter/Views/KittyStoreHostView.swift"
require_grep "KittyStore host dynamically loads embedded framework" "KittyStoreDynamicLoader" "apps/ios/Sources/Litter/Views/KittyStoreHostView.swift"
require_grep "KittyStore host loads SideStore framework at route time" "Bundle.main.privateFrameworksURL" "apps/ios/Sources/Litter/Views/KittyStoreHostView.swift"
require_grep "KittyStore host calls Objective-C entry point dynamically" "class_getClassMethod" "apps/ios/Sources/Litter/Views/KittyStoreHostView.swift"
...
require_grep "Litter does not launch-link KittyStore framework" "link: false" "apps/ios/project.yml"
require_grep "CI rejects direct Litter SideStore framework link" "@rpath/SideStore.framework/SideStore" ".github/workflows/ios-unsigned-ipa.yml"
