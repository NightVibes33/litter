...
require_grep "emexDE target resolves upstream root headers" "ThirdParty/EmexDE/Source \$(SRCROOT)/../../ThirdParty/EmexDE/Source/Frameworks \$(SRCROOT)/../../ThirdParty/EmexDE/Source/Nyxian/LindChain/ProcEnvironment/LiveContainer/ZSign/common \$(SRCROOT)/../../ThirdParty/EmexDE/Source/Nyxian" "apps/ios/project.yml"
...
require_grep "emexDE route checks current LiveProcess API" "PEGetLiveProcessBundle() != nil" "apps/ios/Sources/EmexDEEmbedded/EmexDEEmbeddedFactory.swift"
require_grep "emexDE route checks current builder state" "NXBuilder.builds" "apps/ios/Sources/EmexDEEmbedded/EmexDEEmbeddedFactory.swift"
...
require_grep "emexDE CI patches LiveProcess source plist metadata" "ensure_liveprocess_info_plist_metadata" "tools/scripts/patch-emexde-generated-swift-imports-for-ios-ci.py"
require_grep "emexDE CI patches LiveProcess plist bundle id" '<string>$(PRODUCT_BUNDLE_IDENTIFIER)</string>' "tools/scripts/patch-emexde-generated-swift-imports-for-ios-ci.py"
...
require_grep "unsigned IPA rejects extension payloads for sideloaders" "extension/watch/app clip payloads" ".github/workflows/ios-unsigned-ipa.yml"
